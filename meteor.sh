...
$convert -resize 720x720 -extent 1280x720 "$3/res/screen/android/screen-xhdpi-landscape.png"
$convert -resize 480x480 -extent 480x800 "$3/res/screen/android/screen-hdpi-portrait.png"
$convert -resize 200x200 -extent 320x200 "$3/res/screen/android/screen-ldpi-landscape.png"
$convert -resize 720x720 -extent 720x1280 "$3/res/screen/android/screen-xhdpi-portrait.png"
$convert -resize 320x320 -extent 320x480 "$3/res/screen/android/screen-mdpi-portrait.png"
$convert -resize 320x320 -extent 480x320 "$3/res/screen/android/screen-mdpi-landscape.png"
$convert -resize 200x200 -extent 200x320 "$3/res/screen/android/screen-ldpi-portrait.png"
$convert -resize 480x480 -extent 800x480 "$3/res/screen/android/screen-hdpi-landscape.png"
$convert -resize 480x480 -extent 480x800 "$3/res/screen/bada/screen-portrait.png"
$convert -resize 320x320 -extent 320x480 "$3/res/screen/bada-wac/screen-type3.png"
$convert -resize 480x480 -extent 480x800 "$3/res/screen/bada-wac/screen-type4.png"
$convert -resize 240x240 -extent 240x400 "$3/res/screen/bada-wac/screen-type5.png"
$convert -resize 480x480 -extent 480x800 "$3/res/screen/bada-wac/screen-type5.png"
$convert -resize 225x225 -extent 225x225 "$3/res/screen/blackberry/screen-225.png"
$convert -resize 320x320 -extent 320x480 "$3/res/screen/ios/screen-iphone-portrait.png"
$convert -resize 640x640 -extent 960x640 "$3/res/screen/ios/screen-iphone-landscape-2x.png"
$convert -resize 320x320 -extent 480x320 "$3/res/screen/ios/screen-iphone-landscape.png"
$convert -resize 512x512 -extent 768x1004 "$3/res/screen/ios/screen-ipad-portrait.png"
$convert -resize 1024x1024 -extent 1536x2008 "$3/res/screen/ios/screen-ipad-portrait-2x.png"
$convert -resize 512x512 -extent 1024x783 "$3/res/screen/ios/screen-ipad-landscape.png"
$convert -resize 512x512 -extent 640x960 "$3/res/screen/ios/screen-iphone-portrait-2x.png"
$convert -resize 1024x1024 -extent 2008x1536 "$3/res/screen/ios/screen-ipad-landscape-2x.png"
convert "$1" -resize 64x64 "$3/res/screen/webos/screen-64.png"
$convert -resize 480x480 -extent 480x800 "$3/res/screen/windows-phone/screen-portrait.jpg"
